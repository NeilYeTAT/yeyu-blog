  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        className,
        isActive
          ? 'border-theme-primary/35 bg-theme-surface text-theme-primary shadow-[0_12px_28px_color-mix(in_srgb,var(--theme-accent)_18%,transparent)] ring-theme-primary/20 dark:border-neutral-800 dark:bg-black dark:text-white dark:shadow-sm dark:ring-0'
