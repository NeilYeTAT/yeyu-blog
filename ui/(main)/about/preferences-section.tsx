  ...
  return (
    <AboutSection>
      <AboutLine>
        <p>
          最喜欢的日漫是《
          <WaveLink href="https://bgm.tv/subject/240038" target="_blank">
            青春猪头少年不会梦到兔女郎学姐
          </WaveLink>
          》
        </p>
      ...
      <AboutLine>
        <p>
          最喜欢的日剧是《
          <WaveLink href="https://www.ntv.co.jp/orebana/" target="_blank">
            我的事说来话长
          </WaveLink>
          》
        </p>
      ...
      <AboutLine>
        <p>
          最喜欢的电影是《
          <WaveLink href="https://bgm.tv/subject/328674" target="_blank">
            夏日幽灵
          </WaveLink>
          》
        </p>
      ...
      <AboutLine>
        <p>
          最喜欢的游戏是《
          <WaveLink href="https://forza.net/horizon" target="_blank">
            极限竞速: 地平线
          </WaveLink>
          》系列
        </p>
