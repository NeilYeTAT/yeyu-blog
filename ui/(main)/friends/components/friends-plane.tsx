    ...
    <>
      ...
      <div
        ...
        className={cn(
          ...
          '[--friend-plane-border:color-mix(in_srgb,var(--theme-border)_74%,white_26%)] [--friend-plane-hover-border:color-mix(in_srgb,var(--theme-accent)_28%,white_46%)]',
          ...
          '[--friend-plane-icon:var(--theme-accent)] [--friend-plane-muted-text:var(--theme-muted-foreground)] [--friend-plane-text:var(--theme-primary)]',
          ...
          'dark:[--friend-plane-border:rgba(255,255,255,0.12)] dark:[--friend-plane-hover-border:color-mix(in_srgb,var(--theme-ring)_26%,white_14%)]',
          'dark:[--friend-plane-avatar-bg:rgba(255,255,255,0.06)] dark:[--friend-plane-inner-border:rgba(255,255,255,0.16)]',
          'dark:[--friend-plane-icon:color-mix(in_srgb,var(--theme-ring)_62%,white_18%)] dark:[--friend-plane-muted-text:rgba(212,212,216,0.72)] dark:[--friend-plane-text:rgba(244,244,245,0.96)]',
